      ...
      <section className="relative py-12 xs:py-16 md:py-20 px-3 xs:px-4 bg-gradient-to-b from-muted/20 to-background overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none flex justify-center">
          <div className="relative w-full max-w-2xl h-full">
            ...
            <div className="absolute top-[18%] -left-[10%] w-[120%] h-32 md:h-56 bg-green-600/20 dark:bg-green-500/25 adventure:bg-amber-600/25 transform -rotate-[4deg]"></div>

            {/* Second stripe - slanting down-left behind Community */}
            <div className="absolute top-[43.5%] -left-[10%] w-[120%] h-32 md:h-56 bg-green-600/20 dark:bg-green-500/25 adventure:bg-yellow-600/25 transform rotate-[4deg]"></div>

            {/* Third stripe - slanting down-right behind Global */}
            <div className="absolute top-[70%] -left-[10%] w-[120%] h-32 md:h-56 bg-green-600/20 dark:bg-green-500/25 adventure:bg-orange-600/25 transform -rotate-[4deg]"></div>
          </div>
        </div>
